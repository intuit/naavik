...
const (
	...
	DefaultAirAssetSelectorKey        = "express"
...
var (
	...
	AvailableFeatures = []types.FeatureName{types.FeatureGWProxyFilter, types.FeatureRouterFilter, types.FeatureThrottleFilter, types.FeatureVirtualService}
)
